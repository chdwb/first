...
class PhpData{
	...
	(
		...
		"GOODS_ID_2"=>array("GOODS_ID"=>2, "GOODS_NAME"=>"道具2", "GOODS_ISSELL"=>1, "GOODS_PRICE"=>200, "GOODS_EFFECT"=>2, "GOODS_EFFECT_VALUE"=>"dummy", "GOODS_DESC"=>"送给女主可将当前亲密值补满"),
		"GOODS_ID_9"=>array("GOODS_ID"=>9, "GOODS_NAME"=>"道具3", "GOODS_ISSELL"=>1, "GOODS_PRICE"=>200, "GOODS_EFFECT"=>3, "GOODS_EFFECT_VALUE"=>"dummy", "GOODS_DESC"=>"任务A所需道具")
	);
	public $level = array
	(
		"LEV_LEV_1"=>array("LEV_LEV"=>1, "LEV_EXP"=>5, "LEV_DAY"=>1, "LEV_PLAY_VIDEO_EXP"=>"dummy", "LEV_VIDEO_ID"=>"dummy", "LEV_STORY_VIDEO_ID"=>"dummy", "LEV_STORY_VIDEO_FONT"=>"dummy"),
	...
	public $date = array
	(
		"DATE_ID_1"=>array("DATE_ID"=>1, "DATE_NAME"=>"名称1", "DATE_NEED_POWER"=>5, "DATE_NEED_GOODS_ID"=>"dummy", "DATE_NEED_GOODS_COUNT"=>"dummy", "DATE_EXECUTE_TIME"=>15, "DATE_EXP"=>5, "DATE_NEED_LEVEL"=>1),
		"DATE_ID_2"=>array("DATE_ID"=>2, "DATE_NAME"=>"名称2", "DATE_NEED_POWER"=>6, "DATE_NEED_GOODS_ID"=>"dummy", "DATE_NEED_GOODS_COUNT"=>"dummy", "DATE_EXECUTE_TIME"=>25, "DATE_EXP"=>6, "DATE_NEED_LEVEL"=>4),
	...
	(
		...
		"WECHAT_ID_3"=>array("WECHAT_ID"=>3, "WECHAT_LEVEL"=>2, "WECHAT_OPTION"=>"dummy", "WECHAT_EXP"=>"dummy", "WECHAT_NEXT"=>2, "WECHAT_CONTENT"=>"内容3"),
		...
		"WECHAT_ID_7"=>array("WECHAT_ID"=>7, "WECHAT_LEVEL"=>2, "WECHAT_OPTION"=>"dummy", "WECHAT_EXP"=>"dummy", "WECHAT_NEXT"=>3, "WECHAT_CONTENT"=>"内容7"),
		"WECHAT_ID_8"=>array("WECHAT_ID"=>8, "WECHAT_LEVEL"=>2, "WECHAT_OPTION"=>"dummy", "WECHAT_EXP"=>"dummy", "WECHAT_NEXT"=>3, "WECHAT_CONTENT"=>"内容8"),
		"WECHAT_ID_9"=>array("WECHAT_ID"=>9, "WECHAT_LEVEL"=>2, "WECHAT_OPTION"=>"dummy", "WECHAT_EXP"=>"dummy", "WECHAT_NEXT"=>3, "WECHAT_CONTENT"=>"内容9"),
		...
		"WECHAT_ID_13"=>array("WECHAT_ID"=>13, "WECHAT_LEVEL"=>2, "WECHAT_OPTION"=>"dummy", "WECHAT_EXP"=>"dummy", "WECHAT_NEXT"=>4, "WECHAT_CONTENT"=>"内容13"),
		...
		"WECHAT_ID_17"=>array("WECHAT_ID"=>17, "WECHAT_LEVEL"=>2, "WECHAT_OPTION"=>"dummy", "WECHAT_EXP"=>"dummy", "WECHAT_NEXT"=>"dummy", "WECHAT_CONTENT"=>"内容17")
	);
	public $level_up = array
	(
	...
	public $function_conditions = array
	(
	...
	(
		...
		"ID_6"=>array("ID"=>6, "ZONE_LEVEL"=>8, "ZONE_TITLE"=>"朋友圈主题内容6", "ZONE_IMG_1"=>"dummy", "ZONE_IMG_2"=>"dummy", "ZONE_IMG_3"=>"dummy", "ZONE_IMG_4"=>"dummy", "ZONE_FOLLOW_NUM"=>6, "ZONE_FANS_COUNT"=>6, "ZONE_THUMBS_UP"=>6, "FB_END_ID"=>11),
		"ID_7"=>array("ID"=>7, "ZONE_LEVEL"=>9, "ZONE_TITLE"=>"朋友圈主题内容7", "ZONE_IMG_1"=>5, "ZONE_IMG_2"=>3, "ZONE_IMG_3"=>"dummy", "ZONE_IMG_4"=>"dummy", "ZONE_FOLLOW_NUM"=>7, "ZONE_FANS_COUNT"=>7, "ZONE_THUMBS_UP"=>7, "FB_END_ID"=>11),
		"ID_8"=>array("ID"=>8, "ZONE_LEVEL"=>10, "ZONE_TITLE"=>"朋友圈主题内容8", "ZONE_IMG_1"=>"dummy", "ZONE_IMG_2"=>"dummy", "ZONE_IMG_3"=>"dummy", "ZONE_IMG_4"=>"dummy", "ZONE_FOLLOW_NUM"=>8, "ZONE_FANS_COUNT"=>8, "ZONE_THUMBS_UP"=>8, "FB_END_ID"=>11)
	);
	public $zonefeefback = array
	(
		"ID_1"=>array("ID"=>1, "ZONE_FB_LEVEL"=>3, "ZONE_FB_HAVE_FB"=>"dummy", "ZONE_FB_FNAME"=>"阿里巴巴", "ZONE_FB_TEXT"=>"好友评论1", "ZONE_FB_REPLY"=>"主人回复1"),
		"ID_2"=>array("ID"=>2, "ZONE_FB_LEVEL"=>3, "ZONE_FB_HAVE_FB"=>"dummy", "ZONE_FB_FNAME"=>"腾讯巴巴", "ZONE_FB_TEXT"=>"好友评论2", "ZONE_FB_REPLY"=>"主人回复2"),
		"ID_3"=>array("ID"=>3, "ZONE_FB_LEVEL"=>3, "ZONE_FB_HAVE_FB"=>"dummy", "ZONE_FB_FNAME"=>"萨瓦迪卡", "ZONE_FB_TEXT"=>"好友评论3", "ZONE_FB_REPLY"=>"主人回复3"),
		"ID_4"=>array("ID"=>4, "ZONE_FB_LEVEL"=>3, "ZONE_FB_HAVE_FB"=>"dummy", "ZONE_FB_FNAME"=>"特郭晓梅", "ZONE_FB_TEXT"=>"好友评论4", "ZONE_FB_REPLY"=>"dummy"),
		"ID_5"=>array("ID"=>5, "ZONE_FB_LEVEL"=>3, "ZONE_FB_HAVE_FB"=>"dummy", "ZONE_FB_FNAME"=>"泰国欧", "ZONE_FB_TEXT"=>"好友评论5", "ZONE_FB_REPLY"=>"主人回复4"),
		"ID_6"=>array("ID"=>6, "ZONE_FB_LEVEL"=>3, "ZONE_FB_HAVE_FB"=>"dummy", "ZONE_FB_FNAME"=>"欧巴", "ZONE_FB_TEXT"=>"好友评论6", "ZONE_FB_REPLY"=>"主人回复6"),
		"ID_7"=>array("ID"=>7, "ZONE_FB_LEVEL"=>3, "ZONE_FB_HAVE_FB"=>"dummy", "ZONE_FB_FNAME"=>"欧尼酱", "ZONE_FB_TEXT"=>"好友评论7", "ZONE_FB_REPLY"=>"主人回复7"),
		"ID_8"=>array("ID"=>8, "ZONE_FB_LEVEL"=>3, "ZONE_FB_HAVE_FB"=>1, "ZONE_FB_FNAME"=>"偶了将", "ZONE_FB_TEXT"=>"好友评论8", "ZONE_FB_REPLY"=>"dummy"),
